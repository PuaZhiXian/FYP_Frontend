...
import {ApiCollectionService} from 'src/app/service/apiCollection/api-collection.service';
...
export class AccessControlComponent implements OnInit {
  ...
  editAccessControl(apiCollectionId: number, apiCollectionName: string, active: boolean, i: number) {
    this.currentOpenCollection = i;
    if (active) {
      this.modal.confirm({
  ...
  giveRevokeAccessControl(vendorId: string, apiCollectionId: number[], give: boolean) {
    let requestBody: IAdminSetAccessControl = {
      vendor_id: vendorId,
